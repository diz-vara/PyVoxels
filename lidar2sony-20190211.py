...
camera = 'cam_1'
angle = np.radians(180); # 180-45, 180, 180+45 
...
rot,t = _proc_cal_idx([1])

cam_calib_dict = {"mtx":mtx, "dist":dist, "rot":rot, "t":t, "camera_center":angle, 
                   "camera_name":"argus_"+ camera}    
                   
pickle.dump(cam_calib_dict,open("sony_"+camera+"_dict_81.p",'wb'))

        
save_calib_json('sony_'+camera+"81.json", cam_calib_dict)

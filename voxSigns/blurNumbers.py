...
if __name__ == "__main__":
    ...
    parser.add_argument('base_dir', help='Base directory',
                        default='/media/nvidia/ssd/Voxels/201904_UK/20190403_064438/argus_cam_0/')
    parser.add_argument('-input_dir', help='Input directory',
                        default='data')
    parser.add_argument('-mask_dir', help='Mask directory',
                        default='Xroad')
    ...
    print('Input directory:', os.path.join(args.base_dir, args.input_dir))
    ...
    blurNumbers(os.path.join(args.base_dir, args.input_dir),
                os.path.join(args.base_dir, args.mask_dir),
                os.path.join(args.base_dir, args.output_dir) )

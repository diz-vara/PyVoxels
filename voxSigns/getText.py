...
cam_1_dict = pickle.load(open('/media/nvidia/Data/Voxels/sony_cam_1_dict.p','rb'))
cascadeText = cv2.CascadeClassifier('/media/nvidia/Data/Voxels/Arrows/cTxt_16x24_1_60_s05.xml')
# cTxt_12x18_1_60_s09.xml')
 #cTxt_16x24_1_60_s05.xml' )
#
...
def getText(base_dir, out_dir = "", start = 0, end = -1):
    if (base_dir is None):
    ...
    with tf.Session(graph=arrowsNet, config=config) as sess:
        ...
        for _file in im_files:
            ...
            try:
                ...
                detected = cascadeText.detectMultiScale(warped,
                                                          1.1,
                                                          minNeighbors=2,
                                                          minSize=(50,75),
                                                          maxSize=(300,450))
...
if __name__ == "__main__":
    ...
    for i in range (1, nArg):
        args[i-1] = sys.argv[i]
    getText(args[0], args[1], args[2], args[3])            
